...
#conversion endpoint POST method
...
def post_convert(payload: Post):
    ...
    subprocess.run(["/home/ubuntu/one-click-hello/ffmpeg-api/prepare-dir.sh", f"{payload.post_id}"])
    ...
    subprocess.run(["/home/ubuntu/one-click-hello/ffmpeg-api/ffmpeg-convert.sh", f"{payload.post_id}"])

    #pass the video file as a response
    return fastapi.responses.FileResponse(f"/home/ubuntu/one-click-hello/ffmpeg-api/converted/{payload.post_id}/{payload.post_id}.mp4")
